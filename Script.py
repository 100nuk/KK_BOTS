...
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/Movie_search_V4_bot>♥⁠╣𝑇𝑂𝑁𝑌 𝑆𝑇𝐴𝑅𝐾 𝐹𝑖𝑙𝑡𝑒𝑟 𝑏𝑜𝑡╠⁠♥</a>
 ‣ My best friend : <a href='tg://settings'>♥⁠╣ᴛʜɪs ᴘᴇʀsᴏɴ╠⁠♥</a> 
 ‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/R_KOHLI'>♥⁠╣𝑰𝒕𝒛 𝒎𝒆 𝒕𝒈⁠╠⁠♥</a> 
...
𝐂𝐎𝐍𝐓𝐀𝐂𝐓 - <a href='https://t.me/R_KOHLI'>♥⁠╣𝐎𝐖𝐍𝐄𝐑╠⁠♥ </a></b>


𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 - <a href='https://t.me/movie_a1'>♥⁠╣ᴄʟɪᴄᴋ ʜᴇʀᴇ╠⁠♥</a></b>"""
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/R_KOHLI>☢KK_BOTS☢</a></b>
...
• /plink - <code>Jᴜsᴛ ʟɪᴋᴇ /link, ʙᴜᴛ ᴛʜᴇ ғɪʟᴇ ᴡɪʟʟ ʙᴇ sᴇɴᴅ ᴡɪᴛʜ ғᴏʀᴡᴀʀᴅ ʀᴇsᴛʀɪᴄᴛɪᴏɴ.</code>"""
 ...
 ᴇxᴀᴍᴩʟᴇ :<code>/mp4 https://youtu.be/example...</code></b>""" 
    ...
    GRP_TXT = """
<b>──────「 <a href='https://telegram.me/DK_update'>ᴇᴀʀɴ ᴍᴏɴᴇʏ</a> 」──────
...
›› sᴛᴇᴘ 𝟹 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ <a href='https://t.me/ilove_ram/147'>ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ</a>.
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 🌟 "பிரீமியம் மெம்பர்ஷிப்" 🌟 🥁 'பிரீமியம் மெம்பர்ஷிப்' வாங்குங்கள் & திரைப்படங்கள், தொடர்கள் போன்றவற்றை, எந்த 🔗இணைப்புகள் அல்லது விளம்பரங்கள் இல்லாமல் நேரடி கோப்புகளில் பெறுங்கள்...! 💫 Iɴ Oɴʟʏ 40/- Pᴇʀ Mᴏɴᴛʜ..... ۞ சீக்கிரம் வாங்க.. ஏதேனும் சந்தேகங்கள் அல்லது இணைக்கவில்லையா? என்னை தொடர்பு கொள்ளவும் @R_KOHLI..."""
...
Any Doubts or Not Connecting? Contact Me @R_KOHLI..."""

    TELUGU_INFO = """
హే <a href='tg://settings'>My Friend</a> 


 🌟 "ప్రీమియం మెంబర్‌షిప్" 🌟 🥁 'ప్రీమియం మెంబర్‌షిప్' కొనండి & సినిమాలు, సిరీస్ మొదలైనవాటిని, ఎలాంటి 🔗లింక్‌లు లేదా ప్రకటనలు లేకుండా డైరెక్ట్ ఫైల్‌లలో పొందండి...! 💫 నెలకు 40/- మాత్రమే..... ۞ త్వరగా కొనండి.. ఏవైనా సందేహాలు ఉన్నాయా లేదా కనెక్ట్ కాలేదా? నన్ను సంప్రదించండి @R_KOHLI..."""

    HINDI_INFO = """
अरे <a href='tg://settings'>My Friend</a> 


 🌟"प्रीमियम सदस्यता" 🌟 🥁 'प्रीमियम सदस्यता' खरीदें और बिना किसी लिंक या विज्ञापन के सीधे फाइलों में फिल्में, सीरीज आदि प्राप्त करें...! 💫 मात्र 40/- प्रति माह... ۞ जल्दी खरीदें.. कोई संदेह या कनेक्ट नहीं हो रहा? मुझसे संपर्क करें @R_KOHLI..."""

    MALAYALAM_INFO = """
ഹേയ് <a href='tg://settings'>My Friend</a> 


 🌟 "പ്രീമിയം അംഗത്വം" 🌟 🥁 'പ്രീമിയം അംഗത്വം' വാങ്ങൂ & സിനിമകൾ, സീരീസ് മുതലായവ, 🔗ലിങ്കുകളോ പരസ്യങ്ങളോ ഇല്ലാതെ നേരിട്ടുള്ള ഫയലുകളിൽ നേടൂ...! 💫 പ്രതിമാസം 40/- മാത്രം..... ۞ വേഗം വാങ്ങൂ.. എന്തെങ്കിലും സംശയങ്ങൾ ഉണ്ടോ അല്ലെങ്കിൽ ബന്ധിപ്പിക്കുന്നില്ലേ? എന്നെ @R_KOHLI ബന്ധപ്പെടുക..."""

    URTU_INFO = """
  ہیلو <a href='tg://settings'>My Friend</a>
 
 🌟 "پریمیم ممبرشپ" 🌟 🥁 'پریمیم ممبرشپ' خریدیں اور فلمیں، سیریز وغیرہ حاصل کریں، بغیر کسی 🔗 لنکس یا اشتہارات کے براہ راست فائلوں میں...! 💫 صرف 40/- ماہانہ میں..... ۞ جلدی خریدیں.. کوئی شک ہے یا نہیں جڑ رہا؟ مجھ سے @R_KOHLI رابطہ کریں۔..."""

    GUJARATI_INFO = """
અરે <a href='tg://settings'>My Friend</a> 


 🌟 "પ્રીમિયમ મેમ્બરશિપ" 🌟 🥁 'પ્રીમિયમ સભ્યપદ' ખરીદો અને કોઈપણ 🔗લિંક્સ અથવા જાહેરાતો વિના સીધી ફાઇલોમાં મૂવીઝ, સિરીઝ વગેરે મેળવો...! 💫 માત્ર 40/- દર મહિને..... ۞ ઝડપી ખરીદો.. કોઈ શંકા છે કે કનેક્ટિંગ નથી? મારો સંપર્ક કરો @R_KOHLI..."""

    KANNADA_INFO = """
ಹೇ {message.from_user.mention}

 🌟 "ಪ್ರೀಮಿಯಂ ಸದಸ್ಯತ್ವ" 🌟 🥁 'ಪ್ರೀಮಿಯಂ ಸದಸ್ಯತ್ವ' ಖರೀದಿಸಿ & ಯಾವುದೇ 🔗ಲಿಂಕ್‌ಗಳು ಅಥವಾ ಜಾಹೀರಾತುಗಳಿಲ್ಲದೆ ನೇರ ಫೈಲ್‌ಗಳಲ್ಲಿ ಚಲನಚಿತ್ರಗಳು, ಸರಣಿಗಳು ಇತ್ಯಾದಿಗಳನ್ನು ಪಡೆಯಿರಿ...! 💫 IN ತಿಂಗಳಿಗೆ ಕೇವಲ 40/-..... ۞ ವೇಗವಾಗಿ ಖರೀದಿಸಿ.. ಯಾವುದೇ ಅನುಮಾನಗಳು ಅಥವಾ ಸಂಪರ್ಕವಿಲ್ಲವೇ? ನನ್ನನ್ನು ಸಂಪರ್ಕಿಸಿ @R_KOHLI..."""

    BANGLADESH_INFO = """
আরে <a href='tg://settings'>My Friend</a> 

 🌟 "প্রিমিয়াম মেম্বারশিপ" 🌟 🥁 'প্রিমিয়াম সদস্যপদ' কিনুন এবং কোনো 🔗লিংক বা বিজ্ঞাপন ছাড়াই সরাসরি ফাইলে মুভি, সিরিজ ইত্যাদি পান...! 💫 মাত্র 40/- প্রতি মাসে..... ۞ দ্রুত কিনুন.. কোনো সন্দেহ বা সংযোগ নেই? আমার সাথে যোগাযোগ করুন @R_KOHLI..."""


    DEVELOPER_TXT = """
special Thanks To ❤️ Developers -

-Dev 1 [Owner of this bot ]<a href='https://t.me/R_KOHLI'>♥⁠╣𝑰𝒕𝒛 𝒎𝒆 𝒕𝒈⁠╠⁠♥</a>

-Dev 2 <a href='https://t.me/KK_BOTS'>VJ</a>

-Dev 3 <a href='https://t.me/movie_a1>Jᴏᴇʟ </> TɢX</a>

- Dev 4 <a href='https://t.me/movie_on1'>TEAM VJ</a>
"""
