...
API_ID = int(environ.get('API_ID', '144387'))
API_HASH = environ.get('API_HASH', 'baeb7d71bd10a97fce7ad9707d')
BOT_TOKEN = environ.get('BOT_TOKEN', "7091836629:AAGZnPiWX2bmQK7YvVxId9j2PD8puIaU")
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001606979665')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+qUk9BEId5Lw3MzM1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movie_a1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/ilove_ram/139')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', '♥⁠╣𝑯𝒆𝒍𝒍𝒐 𝒎𝒚 𝑫𝒆𝒂𝒓 𝑭𝒓𝒊𝒆𝒏𝒅𝒔⁠ 𝑾𝒆𝒍𝒍𝒄𝒐𝒎 𝑴𝒐𝒗𝒊𝒆 𝑺𝒆𝒂𝒓𝒄𝒉 𝑮𝒓𝒐𝒖𝒑╠⁠♥')
...
URL = "https://kk-bot-7160e218a862.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kk-bot-7160e218a862.herokuapp.com/".format(FQDN, PORT)
