...
BOT_TOKEN = environ.get('BOT_TOKEN', "5776083140:AAHwzlq9i1UbKDW_QkJAAPMsswVLW5hxpcE")
...
URL = "https://tony-stark-854fb2dc676f.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://tony-stark-854fb2dc676f.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://tony-stark-854fb2dc676f.herokuapp.com/".format(FQDN)
else:
    URL = "https://tony-stark-854fb2dc676f.herokuapp.com/".format(FQDN)
